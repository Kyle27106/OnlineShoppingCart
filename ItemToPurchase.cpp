...
ItemToPurchase::ItemToPurchase(string name, string description, int price,
                               int quantity) {
  itemName = name;
  itemPrice = price;
...
// accessors and mutators for setting and accessing values
...
void ItemToPurchase::SetDescription(string item) { itemDescription = item; }
